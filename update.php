                        ...
                        <tbody>
                            ...
                            foreach ($records as $record) {
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="uname" value="<?php echo $record['name'] ?>"></td>
                                    <td><input type="text" name="uemail" value="<?php echo $record['email'] ?>"></td>
                                    <td><input type="text" name="uphone" value="<?php echo $record['phone'] ?>"></td>
                                    <td><input type="text" name="ugrade" value="<?php echo $record['grade'] ?>"></td>
                                    <td>
                                        <img src="img/<?php echo basename($record["image"]); ?>" height="100" width="100" title="<?php echo $record['image']; ?>">
                                        <!-- Add the file input for updating the image -->
                                        <input type="file" name="uimage" accept=".jpg, .jpeg, .png, .gif">
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
